...
if(isset($_POST['btn']) && $_POST['btn'] == 'SI'){
    $id = $_POST["medicionID"];
    $QUERYdel = "DELETE FROM mediciones WHERE medicionID='$id'";
...
<body>
    ...
    <div class="position-absolute top-50 start-50 translate-middle">
        <form name="form3" action="eliminarMedicion.php" method="post">
        <h1>Válvulas PSI Pozos Petroleros</h1><br>
        <h2>Eliminar Medición</h2><br>
        <label style="font-size: 17px !important;"><b>¿Desea eliminar este medición?</b></label><br>
